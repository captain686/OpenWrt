...
# Themes
svn co https://github.com/liuran001/openwrt-packages/trunk/luci-theme-edge package/luci-theme-edge
svn co https://github.com/rosywrt/luci-theme-rosy/trunk/luci-theme-rosy package/luci-theme-rosy
git clone https://github.com/apollo-ng/luci-theme-darkmatter.git package/luci-theme-darkmatter
svn co https://github.com/haiibo/openwrt-packages/trunk/luci-theme-atmaterial_new package/luci-theme-atmaterial
