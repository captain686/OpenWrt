...
# 科学上网插件
svn export https://github.com/ysx88/openwrt-packages/trunk/luci-app-ssr-plus package/luci-app-ssr-plus
...
# 修复 hostapd 报错
wget https://raw.githubusercontent.com/haiibo/OpenWrt/main/scripts/011-fix-mbo-modules-build.patch -O package/network/services/hostapd/patches/011-fix-mbo-modules-build.patch
